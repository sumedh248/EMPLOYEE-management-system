...
$status = '1';
 ...
 $sql = "SELECT * FROM tblemployee WHERE email='" .$email. "' and password = '".$password."'  ";
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input class="form-control" type="email" placeholder="Email Address" required id="txtemail" name="txtemail" >
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
