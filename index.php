    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 offset-lg-1">
                <div class="hero-login-form mx-auto p-4 mr-5 rounded mt-5 mt-lg-0 bg-white">
                    <div class="text-center">
                        <h5 class="form-title mb-4">A Case study of EMPLOYEE MANAGEMENT</h5>
                    </div>
                    <img src="images/img1.jpg" alt="" class="img-fluid mx-auto d-block">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="hero-title pl-5 ml-5 ">
