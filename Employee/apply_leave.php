                        ...
                        <div class="dropdown profile-element"> <span>
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear"><span
                                        class="text-muted text-xs block"><?php echo $rowaccess['email']; ?> <b
                                        ...
                                        <div class="col-sm-6 b-r">
                                            ...
                                            <form role="form" method="POST">
                                                <div class="form-group"><strong>
                                                    ...
                                                    <input type="date" name="txtstart_date"
                                                        value="<?php if (isset($_POST['txtstart_date'])) ?><?php echo $_POST['txtstart_date']; ?>"
                                                        placeholder="Enter Old Password" class="form-control" required="">
                                                </div>
                                                <div class="form-group"><strong>
                                                        <label>End Date</label></strong>
                                                    <input type="date" name="txtend_date"
                                                        value="<?php if (isset($_POST['txtend_date'])) ?><?php echo $_POST['txtend_date']; ?>"
                                                ...
                                                <div>
                                                    <button class="btn btn-sm btn-primary pull-right m-t-n-xs" type="submit"
                                                        name="btnapply"><strong>Apply</strong></button>
                                                </div>
                                            </form>
                                        </div>
                                        <div class="col-sm-6">
