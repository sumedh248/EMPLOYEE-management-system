						...
						{ ?>
                          ...
                          <?php } ?>		
                           ...
                           <div align="center">
                             <?php if($row['status']=="Pending"  )
                            { ?>
                            <a href="process_leave.php?id=<?php echo $row['leaveID'];?>" onClick="return approve('<?php echo $row['fullname']; ?>');"><i class="fa fa-check  p-2" title="Approve Leave Application"> </i> </a>
                              
                              <a href="process_leave.php?did=<?php echo $row['leaveID'];?>" onClick="return decline('<?php echo $row['fullname']; ?>');"> <i class="fa fa-times p-2" title="Decline Leave Application"> </i> </a>
                            <?php } ?>
